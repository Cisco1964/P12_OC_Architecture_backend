...
class Clients(models.Model):
    ...
    salescontact = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, 
...
class Contrats(models.Model):
    ...
    salescontact = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, 
                    null=True, blank=True)
    client = models.ForeignKey(Clients, on_delete=models.CASCADE, related_name='contrat')
    datecreated = models.DateTimeField(auto_now_add=True)
    dateupdated = models.DateTimeField(auto_now=True)
    contratstatus = models.BooleanField(default=False, verbose_name='contrat non signé/Signé') 
...
class Events(models.Model):
    ...
    contrat = models.OneToOneField(Contrats, on_delete=models.CASCADE, related_name='event')
    datecreated = models.DateTimeField(auto_now_add=True)
    dateupdated = models.DateTimeField(auto_now=True)
    supportcontact = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, 
                    null=True, blank=True)
